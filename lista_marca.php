...
<html lang="pt-br">
	<head>
		...
		<link href="lista_marca.css" rel="stylesheet">
    ...
    <div id="container">
			...
			<div id="wb_Text17" style="position:absolute;left:150px;top:17px;width:550px;height:42px;z-index:5;text-align:left;">
				<span style="color:#000000;font-family:Arial;font-size:37px;">MARCAS</span>
			</div>
        <div id="wb_Form1" style="position:absolute;left:8px;top:79px;width:688px;height:103px;z-index:10;">
            <?php
                ...
                $sql = "SELECT cod_marca, descricao_marca
                        FROM marca
                        WHERE descricao_marca LIKE '$filtro%'";
                $rs = mysqli_query($link,$sql);
                    echo '<table border=1>
                            <th bgcolor=#EEEEEE>Lista de Marcas Cadastradas</th><tr><td>
                            <table border=0>
                            <tr>
                            <td width= "60">&nbsp;</td>
                            <td width= "60">&nbsp;</td>
                            <td width= "200"><b>Código</td>
                            <td width="260"><b>Descrição Marca</td>
                            </tr>';
                if(empty($rs) OR mysqli_num_rows($rs)==0) {
                    ...
                    while($r = mysqli_fetch_array($rs)){
                        echo "<tr>
                                    <td> </td>
                                    <td><a href=\"cadastro_marca.php?codigo=".$r['cod_marca']."\">
                        ...
                        echo "<tr><td><table width=100% border=0><tr><td>
                            <input type=button value=Novo onClick=\"location='cadastro_marca.php';\"></td>
